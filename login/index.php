...
<title>Курсовая работа | Авторизация</title>
...
<div class="login-form">
    <form action="/php/database/auth/sign-in.php" method="post">
    ...
    <p class="text-center"><a href="/register/index.php">Создайте аккаунт</a></p>
</div>
</body>
</html>